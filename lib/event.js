...
// exports.getGroupActorChecks = async function getGroupActorChecks(data, cb) {
//   let app = this.app;
//   let socket = this.socket;
//   try {
//     if(!app.player) {
...
//       return;
//     }
//     let groupActorChecks = await group.getGroupActorChecksAsync();
//     let res = [];
//     for (let gac of groupActorChecks) {
//       res.push(await gac.getObjectAsync());
//     }
//     cb({result: true, actorChecks: res});
//     db.close();
//   } catch (e) {
//     cb({result: false, msg: e.toString()});
//   }
...
exports.setPlayerSelectedGroupActor = async function setPlayerSelectedGroupActor(data, cb) {
  ...
  try {
    ...
    cb({result: true, {groupUUID, groupActorUUID}});
  }catch(e) {
    cb({result: false, msg: e.toString()});
  }
}
